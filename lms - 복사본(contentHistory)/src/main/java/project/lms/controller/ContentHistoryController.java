...
public class ContentHistoryController {
    ...
    @PostMapping("/create")
    public ResponseEntity<ResponseDto<ContentHistory>> createContentHistory(@RequestBody ContentHistoryDto contentHistoryDto) {
        // ContentHistoryDto로부터 MemberId와 ContentId를 추출하여 사용
        ResponseDto<ContentHistory> contentHistory = contentHistoryService.createContentHistory(contentHistoryDto);
